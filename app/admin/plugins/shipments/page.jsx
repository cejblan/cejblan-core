  ...
  return (
    <div className="max-w-6xl mx-auto p-2">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4 text-center sm:text-left">
        <button onClick={goToPrevMonth} className="px-3 py-1 border rounded hover:bg-gray-100 text-sm">
          ← Mes anterior
        </button>
        <h1 className="text-xl sm:text-2xl font-bold capitalize">
          {startOfMonth.format("MMMM YYYY")}
        </h1>
        <button onClick={goToNextMonth} className="px-3 py-1 border rounded hover:bg-gray-100 text-sm">
          Mes siguiente →
        </button>
      </div>
