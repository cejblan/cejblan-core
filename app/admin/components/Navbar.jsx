...
export default function NavbarAdriAdmin({ children }) {
  ...
  const tablero = "/adriliciaus/admin";
  const users = "/adriliciaus/admin/users";
  const usersId = /\/adriliciaus\/admin\/users\/?/;
  const usersIdVerified = usersId.test(pathname);
  const newUsers = "/adriliciaus/admin/users/new";
  const products = "/adriliciaus/admin/products";
  const productsId = /\/adriliciaus\/admin\/products\/?/;
  const productsIdVerified = productsId.test(pathname);
  const newProduct = "/adriliciaus/admin/products/new";
  const categories = "/adriliciaus/admin/categories";
  const newCategory = "/adriliciaus/admin/categories/new";
  const payments = "/adriliciaus/admin/payments";
  const newPay = "/adriliciaus/admin/payments/new";
  const deliveries = "/adriliciaus/admin/deliveries";
  const newDelivery = "/adriliciaus/admin/deliveries/new";
  const orders = "/adriliciaus/admin/orders";
  const telegram = "/adriliciaus/admin/telegram";
  const appearance = "/adriliciaus/admin/appearance";
  const handleClick = () => {
    setIsOpen(!isOpen);
  };
