        ...
        <tbody className="max-[420px]:text-xs text-base">
          {
            payments.map((payments, index) => {
              return (
                <tr key={index}>
                  <td className="border-r border-t border-slate-900">{payments.name}</td>
                  <td className="border-r border-t border-slate-900">{payments.data}</td>
                  ...
                  <td className="py-1 border-t border-slate-900">
                    <Link
                      ...
                      className="text-white bg-[#6ed8bf] hover:bg-[#4bb199] font-bold px-2 rounded-xl shadow-6xl m-auto w-fit block"
                    >
                      Ver
                    </Link>
                  </td>
