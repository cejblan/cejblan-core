...
export default function NavbarAdri() {
  ...
  function urlClass(href) {
    if (pathname === href) {
      return (
        "bg-gradient-to-b from-blue-700 via-slate-700 to-pink-700"
      );
    } else {
      return (
        "bg-slate-700"
  ...
  return (
    <DoNotShowAdmin>
      <nav id="navAdriliciaus" className="bg-gradient-to-b from-blue-700 via-purple-700 to-pink-700 text-white text-xl font-bold justify-center items-center grid max-[420px]:grid-cols-6 grid-cols-12 gap-1 py-1 px-2 shadow-8xl h-9 w-full z-30 fixed">
        {session?.user ?
          <>
          ...
          :
          <button
            className="hover:text-slate-900 max-[420px]:text-sm text-2xl col-start-1 max-[420px]:col-end-2 col-end-3 flex justify-center items-center"
            onClick={() => signIn()}
          >
            <p className="hover:border-slate-900 max-[420px]:leading-3 leading-6 rounded-xl">Iniciar Sesión</p>
        ...
        {session?.user ? (
          <div className="max-[420px]:m-auto max-[420px]:col-start-6 max-[420px]:col-end-6 col-start-9 col-end-13 flex max-[420px]:justify-center justify-end items-center">
          ...
          <div className="max-[420px]:m-auto max-[420px]:col-start-6 max-[420px]:col-end-6 col-start-9 col-end-13 flex max-[420px]:justify-center justify-end items-center">
            ...
            <button
              onClick={Open}
            >
              <PiMagnifyingGlassBold className="w-4 h-4 hover:fill-slate-900" />
            </button>
          </div>
        )}
      </nav>
