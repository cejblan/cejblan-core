...
export default function Cejblan() {
  return (
    <>
      <section id="Cejblan" className="Destacado1 text-white max-[420px]:text-center text-end py-8 max-[420px]:py-4 max-[420px]:px-2 px-12 max-[420px]:block grid content-start justify-end">
...
/*
    <section id="Cejblan" className="Destacado3 bg-center">
